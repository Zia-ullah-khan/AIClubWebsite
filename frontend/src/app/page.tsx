...
const CLUB_DATA = {
  ...
  upcomingEvents: [
    { date: "OCT 26", title: "AI for Art & Design", link: "/events" },
    { date: "OCT 26", title: "Resume Boost with AI", link: "/events" },
    { date: "NOV 9", title: "Building a Simple LLM Agent", link: "/events" },
    { date: "NOV 16", title: "Ethics in AI Panel", link: "/events" },
  ],
};
